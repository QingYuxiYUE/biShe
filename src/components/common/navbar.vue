...
<div id="navbar">
	<md-theme :md-name="theme">
		...
		<transition name="slideD">
			...
			<md-bottom-bar-item @click.native="doAction(0)" :class="{'md-active': isActive[0]}"><i class="iconfont icon-tubiao- btm-nav-icon"></i>动漫</md-bottom-bar-item>
				...
				<md-bottom-bar-item @click.native="doAction(2)" :class="{'md-active': isActive[2]}"><i class="iconfont icon-book btm-nav-icon"></i>漫画</md-bottom-bar-item>
